...
async def RejectMSGtaxt(squad_owner,uid, key, iv):
    random_banner = f"""
[00FF00]ＷＥＬＣＯＭＥ ＴＯ [FF0000]ＤＡＪＡＬ  [00FF00]ＢＯＴ
...
[1E90FF]ＤＥＶ  [FF0000]ＤＡＪＡＬ ＦＦ(ＥＬＩＡ)  

[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]

[9400D3]ＭＡＤＥ  ＢＹ  [FF0000]ＹＯＵＳＳＥＦ  ＬＭＡＺＧＨＩ

[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]

[FFD700]ＹＯＵＴＵＢＥ : [FF0000]ＤＡＪＡＬ  ＦＦ
[FFD700]ＩＮＳＴＡＧＲＡＭ : [FF0000]@ＡＬＥＶＡＩ__3ＶＶ
[FFD700]ＪＯＩＮ  ＴＥＬＥＧＲＡＭ : [FF0000]@ＤＡＪＡＬＦＦ
...
async def xSEndMsg(Msg , Tp , Tp2 , id , K , V):
    feilds = {1: id , 2: Tp2 , 3: Tp, 4: Msg, 5: 1735129800, 7: 2, 9: {1: "adem", 2: int(await xBunnEr()), 3: 901048020, 4: 330, 5: 1001000001, 8: "adem", 10: 1, 11: 1, 13: {1: 2}, 14: {1: 12484827014, 2: 8, 3: "\u0010\u0015\b\n\u000b\u0013\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}, 12: 0}, 10: "en", 13: {3: 1}}
